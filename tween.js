...
(function(root,factory){
    ...
    root.Tween = function(opts){
        if(typeof opts==='undefined'){
            throw new TypeError('需要传入初始化参数');
        }
        if(typeof opts!=='object'){
            throw new TypeError('请传入初始化对象数据');
        }


    };
    root.Tween.prototype.css = function(element, attr , val){
        var that = this;
        if(attr == "scale"||attr == "scaleX"
            ...
            ||attr == "translateZ") {
            return that.cssTransform(element, attr, val);
        }
        if(arguments.length == 2){
            val = getComputedStyle(element)[attr];
            if(attr=='opacity'){
    ...
    root.Tween.prototype.cssTransform = function(element, attr, val){
